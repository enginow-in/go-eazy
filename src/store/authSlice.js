...
const authSlice = createSlice({
  ...
  initialState: {
    ...
    loading: true,
    authChecked: false, // indicates initial session check completed
    authModalOpen: false,
...
export const { setUser, setProfile, setLoading, setAuthChecked, openAuthModal, closeAuthModal, logout } = authSlice.actions
