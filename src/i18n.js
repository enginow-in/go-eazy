  ...
  en: {
    translation: {
      ...
      landlord: {
        ...
        manage: 'Manage your properties and track views.',
        ...
        noListingsDesc: 'Start adding your properties to reach thousands of potential renters.',
        listFirst: 'List Your First Property',
      ...
      userDashboard: {
        ...
        autoClear: 'Auto-clears after 72 hours',
        myVisits: 'My Site Visits',
        noVisits: 'You haven\'t requested any site visits.',
        noSaved: 'You haven\'t saved any properties yet.',
        noRecent: 'No recently viewed properties.',
      ...
      settings: {
        ...
        profileDesc: 'Update your public facing information',
        securitySettings: 'Security Settings',
        securityDesc: 'Ensure your account is using a secure password',
        email: 'Email Address',
        emailLocked: 'Email address cannot be changed currently.',
        fullName: 'Full Name',
        phone: 'Phone Number',
      ...
      unlocked: {
        ...
        subtitle: 'Properties whose contact details you have unlocked.',
        noUnlocked: 'No unlocked properties yet',
        noUnlockedDesc: 'Pay a small fee to unlock contact details for properties you\'re interested in.',
        browse: 'Browse Properties',
        viewProperty: 'View Property',
  ...
  hi: {
    translation: {
      ...
      landlord: {
        ...
        manage: 'अपनी प्रॉपर्टी प्रबंधित करें और व्यू ट्रैक करें।',
        totalListings: 'कुल लिस्टिंग',
        totalViews: 'कुल प्रोफ़ाइल व्यू',
        ...
        noListingsDesc: 'हजारों संभावित किरायेदारों तक पहुंचने के लिए अपनी प्रॉपर्टी जोड़ना शुरू करें।',
        listFirst: 'अपनी पहली प्रॉपर्टी लिस्ट करें',
        ...
        weeklyViews: 'साप्ताहिक प्रोफ़ाइल व्यू',
        visits: 'साइट विज़िट',
        messages: 'संदेश',
      },
      userDashboard: {
        hi: 'नमस्ते, {{name}}!',
        subtitle: 'जहां छोड़ा था वहीं से शुरू करें।',
        savedProperties: 'सहेजी गई प्रॉपर्टी',
        recentlyViewed: 'हाल ही में देखी गई',
        autoClear: '72 घंटे बाद अपने आप साफ़ हो जाता है',
        myVisits: 'मेरी साइट विज़िट',
        noVisits: 'आपने कोई साइट विज़िट अनुरोध नहीं किया है।',
        noSaved: 'आपने अभी तक कोई प्रॉपर्टी सेव नहीं की है।',
        noRecent: 'हाल ही में देखी गई कोई प्रॉपर्टी नहीं।',
        explore: 'लिस्टिंग देखें',
        viewAll: 'सभी देखें',
        items: 'आइटम',
        requests: 'अनुरोध',
        status: {
      ...
      settings: {
        title: 'खाता सेटिंग्स',
        subtitle: 'अपनी व्यक्तिगत जानकारी और सुरक्षा प्राथमिकताएं प्रबंधित करें।',
        profileDetails: 'प्रोफ़ाइल विवरण',
        profileDesc: 'अपनी सार्वजनिक जानकारी अपडेट करें',
        securitySettings: 'सुरक्षा सेटिंग्स',
        securityDesc: 'सुनिश्चित करें कि आपका खाता एक सुरक्षित पासवर्ड का उपयोग कर रहा है',
        email: 'ईमेल पता',
        emailLocked: 'ईमेल पता वर्तमान में बदला नहीं जा सकता।',
        fullName: 'पूरा नाम',
        phone: 'फ़ोन नंबर',
        ...
        profileFailed: 'प्रोफ़ाइल अपडेट करने में विफल। कृपया पुनः प्रयास करें।',
        ...
        passwordFailed: 'पासवर्ड अपडेट करने में विफल'
      },
      compare: {
        price: 'कीमत',
        type: 'प्रकार',
        ...
        viewDetails: 'विवरण देखें',
        clearAll: 'सब साफ़ करें',
        browse: 'प्रॉपर्टी देखें',
        noProperties: 'तुलना के लिए कोई प्रॉपर्टी नहीं',
        noPropertiesDesc: 'साइड बाय साइड तुलना करने के लिए खोज पेज से प्रॉपर्टी जोड़ें।',
        available: 'उपलब्ध',
        rented: 'किराए पर'
      },
      unlocked: {
        title: 'मेरी अनलॉक की गई प्रॉपर्टी',
        subtitle: 'जिन प्रॉपर्टी के संपर्क विवरण आपने अनलॉक किए हैं।',
        noUnlocked: 'अभी तक कोई अनलॉक प्रॉपर्टी नहीं',
        noUnlockedDesc: 'जिन प्रॉपर्टी में आपकी रुचि है, उनके संपर्क विवरण अनलॉक करने के लिए एक छोटा शुल्क दें।',
        browse: 'प्रॉपर्टी देखें',
        viewProperty: 'प्रॉपर्टी देखें',
        unlockedOn: 'को अनलॉक किया गया',
        phone: 'फ़ोन',
        email: 'ईमेल'
      }
    }
