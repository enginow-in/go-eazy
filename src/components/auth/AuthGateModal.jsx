        ...
        <div className="px-6 pt-5 pb-5">
          ...
          {verificationPending ? (
            <div className="text-center py-6 animate-in fade-in duration-300">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-2 font-display">Verify Your Email</h3>
              ...
              <div className="bg-[#F9F8F6] p-4 rounded-xl border border-gray-200 text-xs text-gray-600 mb-6 text-left">
              ...
              <Button variant="secondary" className="w-full rounded-xl" onClick={() => setVerificationPending(false)}>
                Back to Sign In
              </Button>
            </div>
          ) : (
