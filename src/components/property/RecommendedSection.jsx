...
export const RecommendedSection = ({ viewMode = 'grid' }) => {
  ...
  // Use useMemo to cache recommendations on the first load/calculation.
  // It only recomputes when getRecommendedProperties (which depends on profile & listings) changes.
