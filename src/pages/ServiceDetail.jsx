              ...
              <div className="pt-6 border-t border-gray-50">
                {!contactUnlocked ? (
                  ...
                  <div className="space-y-3">
                    ...
                    {service.contact_phone && (
                      <a
                        href={`https://wa.me/${(gatedData?.contact_phone || service.contact_phone).replace(/\D/g, '').length === 10 ? '91' : ''}${(gatedData?.contact_phone || service.contact_phone).replace(/\D/g, '')}?text=${encodeURIComponent(
                          `Hi! I'm interested in your service "${service.name}" listed on GoEazy. Could you please share more details?`
                        )}`}
                        target="_blank"
